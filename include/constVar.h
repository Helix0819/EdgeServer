...
enum RECIPE_WRITE_TYPE {HASH = 0, KEY};
...
enum EDGE_PROTCOL_CODE_SET {
    // for both
    EDGE_LOGIN_RESPONSE = 0, CLOUD_FILE_NON_EXIST,

    // for upload
    EDGE_MIGRATE_LOGIN, 
    EDGE_UPLOAD_SEC_RECIPE, EDGE_UPLOAD_SEC_RECIPE_END,
    EDGE_UPLOAD_RECIPE, EDGE_UPLOAD_RECIPE_END,
    EDGE_UPLOAD_KEY_RECIPE, EDGE_UPLOAD_KEY_RECIPE_END,
    EDGE_MIGRATION_CHUNK, EDGE_MIGRATION_CHUNK_FINAL,
    EDGE_MIGRATION_NEWFILE,

    // for download recipe
    EDGE_DOWNLOAD_RECIPE_LOGIN, EDGE_DOWNLOAD_RECIPE_READY,
    CLOUD_SEND_RECIPE, CLOUD_SEND_SECURE_RECIPE,
    CLOUD_SEND_KEY_RECIPE,
    EDGE_RECEIVE_READY,
    CLOUD_SEND_RECIPE_END,

    // for download chunk
    EDGE_DOWNLOAD_CHUNK_LOGIN, EDGE_DOWNLOAD_CHUNK_READY,
    CLOUD_SEND_CHUNK, CLOUD_SEND_CHUNK_END
    };   
...
enum TWO_PATH_STATUS {UNIQUE = 0, TMP_UNIQUE = 1, DUPLICATE = 2, TMP_DUPLICATE = 3, EXIST = 4, NONEXIST = 5};
...
enum OPT_TYPE {UPLOAD_OPT = 0, DOWNLOAD_OPT, RA_OPT, MIGRATE_TO_CLOUD, RETRIEVE_FROM_CLOUD, DOWNLOAD_FROM_CLOUD};
